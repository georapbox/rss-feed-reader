...
`;var tq=new WeakMap,tU=new WeakMap,t$=new WeakSet,tV=new WeakSet,tZ=new WeakSet;class tG extends HTMLElement{connectedCallback(){tW(this,tZ,tK).call(this,"effect"),tW(this,tZ,tK).call(this,"variant"),this.effect||(this.effect="none")}static get observedAttributes(){return["effect","variant"]}attributeChangedCallback(e,t,n){"effect"===e&&(tB(this,tq).className=tW(this,t$,tJ).call(this,n)),"variant"===e&&(tB(this,tU).className=tW(this,tV,tQ).call(this,n))}get effect(){return this.getAttribute("effect")}set effect(e){this.setAttribute("effect",e)}get variant(){return this.getAttribute("variant")}set variant(e){this.setAttribute("variant",e)}static defineCustomElement(e="skeleton-placeholder"){"undefined"==typeof window||window.customElements.get(e)||window.customElements.define(e,tG)}constructor(){super(),tz(this,t$),tz(this,tV),tz(this,tZ),tj(this,tq,{writable:!0,value:void 0}),tj(this,tU,{writable:!0,value:void 0}),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tX.content.cloneNode(!0)),tH(this,tq,this.shadowRoot.querySelector('[part="wrapper"]')),tH(this,tU,this.shadowRoot.querySelector('[part="placeholder"]'))}}function tJ(e){let t="";switch(e){case"wave":t="skeleton skeleton--wave";break;case"fade":t="skeleton skeleton--fade";break;default:t="skeleton"}return t}function tQ(e){let t="";switch(e){case"circle":t="skeleton__placeholder skeleton__placeholder--circle";break;case"rect":t="skeleton__placeholder skeleton__placeholder--rect";break;case"pill":t="skeleton__placeholder skeleton__placeholder--pill";break;default:t="skeleton__placeholder"}return t}function tK(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}}tG.defineCustomElement();let t0=new Map,t1=async(e,t={})=>{let n=t0.get(e);if(n)return n;let o=await fetch("https://api.rss2json.com/v1/api.json?rss_url="+e,t);if(!o.ok)throw Error("Error fetching data");let i=await o.json();return t0.set(e,i),i},t5=document.createElement("template"),t2=()=>`
...
//# sourceMappingURL=index.d2d3c07a.js.map
