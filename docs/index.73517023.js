let e;function t(e){return e&&e.__esModule?e.default:e}var n,o="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},r={},a=o.parcelRequire3ec4;null==a&&((a=function(e){if(e in i)return i[e].exports;if(e in r){var t=r[e];delete r[e];var n={id:e,exports:{}};return i[e]=n,t.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){r[e]=t},o.parcelRequire3ec4=a),Object.defineProperty({},"ClipboardCopy",{get:function(){return h},set:void 0,enumerable:!0,configurable:!0});let s="clipboard-copy",l="success",d="error",c=document.createElement("template");c.innerHTML=`
  <style>
    :host([hidden]),
    [hidden],
    ::slotted([hidden]) {
...
`;class F extends HTMLElement{constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(I.content.cloneNode(!0))),this.shadowRoot.adoptedStyleSheets=N}}function P(e){return new Promise(function(t,n){e.oncomplete=e.onsuccess=function(){return t(e.result)},e.onabort=e.onerror=function(){return n(e.error)}})}function B(){if(!eI){var e,t,n;e="keyval",(t=indexedDB.open("keyval-store")).onupgradeneeded=function(){return t.result.createObjectStore(e)},n=P(t),eI=function(t,o){return n.then(function(n){return o(n.transaction(e,t).objectStore(e))})}}return eI}window.customElements.get("site-header")||window.customElements.define("site-header",F);const j="rss-reader/feeds",H=async e=>{try{return{value:await function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:B();return t("readonly",function(t){return P(t.get(e))})}(e),error:void 0}}catch(e){return{value:void 0,error:e}}},W=async(e,t)=>{try{return await function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:B();return n("readwrite",function(n){return n.put(t,e),P(n.transaction)})}(e,t),{error:void 0}}catch(e){return{error:e}}},X=async()=>H(j),Y=async(e,t=!0)=>{if(!Array.isArray(e))return;let{error:n}=await W(j,e);return!n&&t&&document.dispatchEvent(new CustomEvent("feeds-updated",{bubbles:!0,detail:{action:"set",feeds:e}})),{error:n}},z=async(e,t=!0)=>{let{value:n=[]}=await X(),o=n.find(t=>t.url===e.url),i="";o?(o.url=e.url,o.title=e.title,i="update"):(n.push(e),i="create");let{error:r}=await W(j,n);return!r&&t&&document.dispatchEvent(new CustomEvent("feeds-updated",{bubbles:!0,detail:{action:i,feed:e}})),{error:r}},q=async(e,t=!0)=>{let{value:n=[]}=await X(),o=n.filter(t=>t.url!==e),{error:i}=await W(j,o);return!i&&t&&(0===o.length&&await function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:B();return t("readwrite",function(t){return t.delete(e),P(t.transaction)})}(j),document.dispatchEvent(new CustomEvent("feeds-updated",{bubbles:!0,detail:{action:"delete",feed:{url:e}}}))),{error:i}},U=document.createElement("template");U.innerHTML=`
  <style>
    :host {
      --input-height: 42px;
...
`;class tI extends HTMLElement{constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tN.content.cloneNode(!0))),this._isEditable=!1,this.shadowRoot.adoptedStyleSheets=N,this.feedsContainerEl=this.shadowRoot.getElementById("feedsContainer"),this.feedsListEl=this.shadowRoot.getElementById("feedsList"),this.editBtn=this.shadowRoot.getElementById("editBtn"),this.exportBtn=this.shadowRoot.getElementById("exportBtn"),this.searchInput=this.shadowRoot.getElementById("searchInput"),this.searchClearBtn=this.shadowRoot.getElementById("searchClearBtn"),this.exportFeedsEl=this.shadowRoot.querySelector("export-feeds")}async connectedCallback(){let{value:e=[]}=await X();e.forEach(e=>this.addFeed(e)),this.toggleFeedsVisibility(),this.feedsListEl.addEventListener("click",this.onActionsClick),this.editBtn.addEventListener("click",this.onEditRequest),this.exportBtn.addEventListener("click",this.onExportRequest),this.searchInput.addEventListener("input",this.onSearchInputDebounced),this.searchClearBtn.addEventListener("click",this.onSearchClear),document.addEventListener("feeds-updated",this.onFeedsUpdateSuccess),new tb(this.feedsListEl,{animation:150,handle:".sort-handler",onEnd:async e=>{let t=Array.prototype.map.call(e.to.querySelectorAll("li"),e=>({url:e.getAttribute("data-url"),title:e.getAttribute("data-title")||""}));await Y(t,!1)}})}disconnectedCallback(){this.feedsListEl.removeEventListener("click",this.onActionsClick),this.editBtn.removeEventListener("click",this.onEditRequest),this.exportBtn.removeEventListener("click",this.onExportRequest),this.searchInput.removeEventListener("input",this.onSearchInputDebounced),this.searchClearBtn.removeEventListener("click",this.onSearchClear),document.removeEventListener("feeds-updated",this.onFeedsUpdateSuccess)}searchFeeds=(e="")=>{let t=this.feedsListEl.querySelectorAll("[data-url]");0!==t.length&&t.forEach(t=>{let n=(t.getAttribute("data-url")||"").toLowerCase(),o=(t.getAttribute("data-title")||"").toLowerCase(),i=e.trim().toLowerCase();t.hidden=!(n.includes(i)||o.includes(i))})};debounceSearchFeeds=tL(this.searchFeeds,250);onSearchInputDebounced=e=>{let t=e.target.value;return this.searchClearBtn.classList.toggle("d-none",!t),this.debounceSearchFeeds(t)};onSearchClear=()=>{this.searchInput.value="",this.searchInput.dispatchEvent(new Event("input"))};onEditRequest=e=>{this._isEditable=!this._isEditable,e.currentTarget.classList.toggle("active"),this.shadowRoot.querySelectorAll(".sort-handler, .delete-button").forEach(e=>{e.hidden=!e.hidden})};onExportRequest=()=>{this.exportFeedsEl.open=!0};onFeedsUpdateSuccess=e=>{if("delete"===e.detail.action&&this.removeFeed(e.detail.feed),"create"===e.detail.action&&(this.addFeed(e.detail.feed),this.searchInput.value&&(this.searchInput.value="",this.searchFeeds(""))),"update"===e.detail.action){let{url:t,title:n}=e.detail.feed,o=this.feedsListEl.querySelector(`[data-url="${t}"]`);if(o){let e=o.querySelector(".link-content");o.setAttribute("data-title",n||""),e&&(e.innerHTML=n?`${n}<br><small class="text-muted">${t}</small>`:t)}}};onActionsClick=e=>{let t=e.target,n=t.closest("button.delete-button"),o=t.closest("a.link");if(!o&&!n)return;let i=t.closest("li"),r=i.getAttribute("data-url");n&&window.confirm(`Are you sure you want to delete feed "${r}"?`)&&q(r),o&&(e.preventDefault(),document.querySelector("feed-reader").feedUrl=r)};addFeed(e){let{url:t,title:n}=e,o=document.createElement("a");o.className="link text-decoration-none d-flex align-items-center h-100",o.style.flex="1",o.style.minWidth=0,o.style.color="inherit",o.href=t;let i=document.createElement("div");i.className="text-truncate link-content",i.innerHTML=n?`${n}<br><small class="text-muted">${t}</small>`:t;let r=document.createElement("button");r.type="button",r.title="Delete feed",r.hidden=!this._isEditable,r.className="delete-button btn btn-default text-danger p-0",r.style.lineHeight="1",r.innerHTML=`
    ...
    `,o.appendChild(i),a.appendChild(s),a.appendChild(o),a.appendChild(r),this.feedsListEl.appendChild(a),this.toggleFeedsVisibility()}removeFeed(e){let t=this.feedsListEl.querySelector(`[data-url="${e.url}"]`);t&&t.remove(),this.toggleFeedsVisibility()}async toggleFeedsVisibility(){let{value:e=[]}=await X();this.feedsContainerEl.classList.toggle("d-none",0===e.length)}}function tF(e,t,n){if(!t.has(e))throw TypeError("attempted to "+n+" private field on non-instance");return t.get(e)}function tP(e,t){var n;return(n=tF(e,t,"get")).get?n.get.call(e):n.value}function tB(e,t){if(t.has(e))throw TypeError("Cannot initialize the same private elements twice on an object")}function tj(e,t,n){tB(e,t),t.set(e,n)}function tH(e,t,n){return function(e,t,n){if(t.set)t.set.call(e,n);else{if(!t.writable)throw TypeError("attempted to set read only private field");t.value=n}}(e,tF(e,t,"set"),n),n}function tW(e,t,n){if(!t.has(e))throw TypeError("attempted to get private field on non-instance");return n}function tX(e,t){tB(e,t),t.add(e)}window.customElements.get("feeds-list")||window.customElements.define("feeds-list",tI),Object.defineProperty({},"SkeletonPlaceholder",{get:function(){return tG},set:n,enumerable:!0,configurable:!0});const tY=document.createElement("template"),tz=String.raw;tY.innerHTML=tz`
  <style>
    :host {
      --border-radius: 0.25rem;
      --color: #ced4da;
...
`;var tq=new WeakMap,tU=new WeakMap,tV=new WeakSet,t$=new WeakSet,tZ=new WeakSet;class tG extends HTMLElement{connectedCallback(){tW(this,tZ,tQ).call(this,"effect"),tW(this,tZ,tQ).call(this,"variant"),this.effect||(this.effect="none")}static get observedAttributes(){return["effect","variant"]}attributeChangedCallback(e,t,n){"effect"===e&&(tP(this,tq).className=tW(this,tV,tJ).call(this,n)),"variant"===e&&(tP(this,tU).className=tW(this,t$,tK).call(this,n))}get effect(){return this.getAttribute("effect")}set effect(e){this.setAttribute("effect",e)}get variant(){return this.getAttribute("variant")}set variant(e){this.setAttribute("variant",e)}static defineCustomElement(e="skeleton-placeholder"){"undefined"==typeof window||window.customElements.get(e)||window.customElements.define(e,tG)}constructor(){super(),tX(this,tV),tX(this,t$),tX(this,tZ),tj(this,tq,{writable:!0,value:void 0}),tj(this,tU,{writable:!0,value:void 0}),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tY.content.cloneNode(!0)),tH(this,tq,this.shadowRoot.querySelector('[part="wrapper"]')),tH(this,tU,this.shadowRoot.querySelector('[part="placeholder"]'))}}function tJ(e){let t="";switch(e){case"wave":t="skeleton skeleton--wave";break;case"fade":t="skeleton skeleton--fade";break;default:t="skeleton"}return t}function tK(e){let t="";switch(e){case"circle":t="skeleton__placeholder skeleton__placeholder--circle";break;case"rect":t="skeleton__placeholder skeleton__placeholder--rect";break;case"pill":t="skeleton__placeholder skeleton__placeholder--pill";break;default:t="skeleton__placeholder"}return t}function tQ(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}}tG.defineCustomElement();const t0=new Map,t1=async(e,t={})=>{let n=t0.get(e);if(n)return n;let o=await fetch("https://api.rss2json.com/v1/api.json?rss_url="+e,t);if(!o.ok)throw Error("Error fetching data");let i=await o.json();return t0.set(e,i),i},t5=document.createElement("template"),t2=()=>`
...
//# sourceMappingURL=index.73517023.js.map
