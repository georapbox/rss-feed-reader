...
`;class tJ extends HTMLElement{#L=null;#_=null;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tZ.content.cloneNode(!0))),this.#L=this.shadowRoot.querySelector("files-dropzone"),this.#_=this.shadowRoot.querySelector('form[name="import-form"]'),this.shadowRoot.adoptedStyleSheets=J}connectedCallback(){this.#L.addEventListener("files-dropzone-drop-accepted",this.#D),this.#_.addEventListener("submit",this.#M)}disconnectedCallback(){this.#L.removeEventListener("files-dropzone-drop-accepted",this.#D),this.#_.removeEventListener("submit",this.#M)}#D=e=>{let{acceptedFiles:t=[]}=e.detail,o=t[0];if(!o)return;let i=new FileReader;i.readAsText(o,"utf-8"),i.onload=this.#R};async #z(e){if(!Array.isArray(e)||0===e.length)return alert("Invalid file or no feeds found.");let{value:t=[]}=await ei();for(let o of e){let e=!!t.find(e=>e.url===o.url),{url:i,title:n}=o,r=es(i);!e&&r&&await er({url:i,title:n})}this.dispatchEvent(new Event("feeds-imported",{bubbles:!0,composed:!0}))}#R=async e=>{try{let{result:t}=e.target;this.#z(JSON.parse(t))}catch{alert("The file is not valid.")}};#M=async e=>{e.preventDefault();let t=new FormData(e.target).get("import-data");try{this.#z(JSON.parse(t))}catch{alert("The data is not valid.")}}}window.customElements.get("import-feeds")||window.customElements.define("import-feeds",tJ);let tQ=(e,t)=>{let o="";try{o=JSON.stringify(e,null,t)}catch(e){console.error(e)}return o},tK=`
  :host {
    display: block;
    max-width: 500px;
  }
...
`,t0=document.createElement("template");t0.innerHTML=`
  <style>${tK}</style>
...
`;class t1 extends HTMLElement{#O=[];#N=null;#I=null;#F=null;#B=null;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(t0.content.cloneNode(!0))),this.#N=this.shadowRoot.getElementById("exportCode"),this.#I=this.shadowRoot.querySelector("clipboard-copy"),this.#F=this.shadowRoot.querySelector("web-share"),this.#B=this.shadowRoot.getElementById("downloadButton"),this.shadowRoot.adoptedStyleSheets=J}static get observedAttributes(){return["visible"]}attributeChangedCallback(e,t,o){if("visible"===e&&t!==o){let e=tQ(this.feeds,2);this.#N.textContent=e,this.#I.value=e,this.#F.shareText=e}}connectedCallback(){this.#B.addEventListener("click",this.#P)}disconnectedCallback(){this.#B.removeEventListener("click",this.#P)}get feeds(){return this.#O}set feeds(e){this.#O=e||[]}get visible(){return this.hasAttribute("visible")}set visible(e){this.toggleAttribute("visible",!!e)}#j(e){let t=new Blob([tQ(e,2)],{type:"application/json"}),o=URL.createObjectURL(t),i=document.createElement("a");i.href=o,i.download="rss-feeds-export.json",i.click(),URL.revokeObjectURL(o)}#P=()=>{this.#j(this.feeds)}}window.customElements.get("export-feeds")||window.customElements.define("export-feeds",t1);let t5=`
  :host {
    display: block;
...
`;class t3 extends HTMLElement{#H=!1;#q=null;#$=null;#U=null;#X=null;#Y=null;#W=null;#V=null;#G=null;#Z=null;#J=null;#Q=null;#K=null;#ee=null;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(t2.content.cloneNode(!0))),this.shadowRoot.adoptedStyleSheets=J,this.#q=this.shadowRoot.getElementById("feedsContainer"),this.#$=this.shadowRoot.getElementById("feedsList"),this.#U=this.shadowRoot.getElementById("editBtn"),this.#X=this.shadowRoot.getElementById("importBtn"),this.#Y=this.shadowRoot.getElementById("importAltBtn"),this.#W=this.shadowRoot.getElementById("exportBtn"),this.#V=this.shadowRoot.getElementById("searchInput"),this.#G=this.shadowRoot.getElementById("searchClearBtn"),this.#Z=this.shadowRoot.getElementById("importDialog"),this.#J=this.shadowRoot.getElementById("exportDialog"),this.#Q=this.shadowRoot.querySelector("import-feeds"),this.#K=this.shadowRoot.querySelector("export-feeds"),this.#ee=this.shadowRoot.getElementById("noFeedsDisclaimer")}async connectedCallback(){let{value:e=[]}=await ei();e.forEach(e=>this.#et(e)),this.#eo(),this.#$.addEventListener("click",this.#ei),this.#U.addEventListener("click",this.#en),this.#Y.addEventListener("click",this.#er),this.#X.addEventListener("click",this.#er),this.#W.addEventListener("click",this.#ea),this.#V.addEventListener("input",this.#es),this.#G.addEventListener("click",this.#el),this.#Z.addEventListener("me-open",this.#ed),this.#J.addEventListener("me-open",this.#ec),this.#J.addEventListener("me-close",this.#eh),this.addEventListener("feeds-imported",this.#eu),document.addEventListener("feeds-updated",this.#ep),new tN(this.#$,{animation:150,handle:".sort-handler",onEnd:async e=>{let t=Array.prototype.map.call(e.to.querySelectorAll("li"),e=>({url:e.getAttribute("data-url"),title:e.getAttribute("data-title")||""}));await en(t,!1)}})}disconnectedCallback(){this.#$.removeEventListener("click",this.#ei),this.#U.removeEventListener("click",this.#en),this.#X.removeEventListener("click",this.#er),this.#Y.removeEventListener("click",this.#er),this.#W.removeEventListener("click",this.#ea),this.#V.removeEventListener("input",this.#es),this.#G.removeEventListener("click",this.#el),this.#Z.removeEventListener("me-open",this.#ed),this.#J.removeEventListener("me-open",this.#ec),this.#J.removeEventListener("me-close",this.#eh),this.removeEventListener("feeds-imported",this.#eu),document.removeEventListener("feeds-updated",this.#ep)}#em=(e="")=>{let t=this.#$.querySelectorAll("[data-url]");0!==t.length&&t.forEach(t=>{let o=(t.getAttribute("data-url")||"").toLowerCase(),i=(t.getAttribute("data-title")||"").toLowerCase(),n=e.trim().toLowerCase();t.hidden=!(o.includes(n)||i.includes(n))})};#ef=tV(this.#em,250);#es=e=>{let t=e.target.value;return this.#G.classList.toggle("d-none",!t),this.#ef(t)};#el=()=>{this.#V.value="",this.#V.dispatchEvent(new Event("input"))};#en=e=>{this.#H=!this.#H,e.currentTarget.classList.toggle("active"),this.shadowRoot.querySelectorAll(".sort-handler, .delete-button").forEach(e=>{e.hidden=!e.hidden})};#er=()=>{this.#Z.open=!0};#ea=()=>{this.#J.open=!0};#ed=()=>{try{this.#Q.shadowRoot.querySelector("a-tab-group").selectTabByIndex(0),this.#Q.shadowRoot.querySelector("textarea").value=""}catch{}};#ec=async()=>{let{value:e=[]}=await ei();this.#K.feeds=e,this.#K.setAttribute("visible","")};#eh=()=>{this.#K.removeAttribute("visible")};#eu=()=>{this.#Z.open=!1};#ep=e=>{if("delete"===e.detail.action&&this.#eb(e.detail.feed),"create"===e.detail.action&&(this.#et(e.detail.feed),this.#V.value&&(this.#V.value="",this.#em(""))),"update"===e.detail.action){let{url:t,title:o}=e.detail.feed,i=this.#$.querySelector(`[data-url="${t}"]`);if(i){let e=i.querySelector(".link-content");i.setAttribute("data-title",o||""),e&&(e.innerHTML=o?`${o}<br><small class="text-muted">${t}</small>`:t)}}};#ei=e=>{let t=e.target,o=t.closest("button.delete-button"),i=t.closest("a.link");if(!i&&!o)return;let n=t.closest("li").getAttribute("data-url");o&&window.confirm(`Are you sure you want to delete feed "${n}"?`)&&ea(n),i&&(e.preventDefault(),document.querySelector("feed-reader").feedUrl=n)};#et(e){let{url:t,title:o}=e,i=document.createElement("a");i.className="link text-decoration-none d-flex align-items-center h-100",i.style.flex="1",i.style.minWidth=0,i.style.color="inherit",i.href=t;let n=document.createElement("div");n.className="text-truncate link-content",n.innerHTML=o?`${o}<br><small class="text-muted">${t}</small>`:t;let r=document.createElement("button");r.type="button",r.hidden=!this.#H,r.className="delete-button btn btn-default text-danger p-0",r.style.lineHeight="1",r.setAttribute("aria-label","Delete feed"),r.innerHTML=`
    ...
    `;let a=document.createElement("li");a.className="list-group-item p-0 d-flex justify-content-between align-items-center",a.style.height="var(--list-item-height)",a.setAttribute("data-url",t||""),a.setAttribute("data-title",o||"");let s=document.createElement("div");s.hidden=!this.#H,s.className="sort-handler text-primary",s.setAttribute("aria-label","Reorder feed"),s.innerHTML=`
...
`,t7=document.createElement("template");t7.innerHTML=`
  <style>${t6}</style>
...
`;class t9 extends HTMLElement{#eg=null;#ev=null;#ew=null;#ey=null;#eE=null;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(t7.content.cloneNode(!0))),this.#eg=this.shadowRoot.getElementById("spinner"),this.#ev=this.shadowRoot.querySelector("modal-element"),this.#ew=this.#ev.querySelector("#feedTitle"),this.#ey=this.shadowRoot.getElementById("feedsViewer"),this.#eE=this.shadowRoot.getElementById("error"),this.shadowRoot.adoptedStyleSheets=J}static get observedAttributes(){return["feed-url"]}attributeChangedCallback(e){"feed-url"===e&&(this.feedUrl?this.#ex(this.feedUrl):this.#eS())}connectedCallback(){this.#ev.addEventListener("me-close",this.#eC)}disconnectedCallback(){this.#ev.removeEventListener("me-close",this.#eC)}get feedUrl(){return this.getAttribute("feed-url")}set feedUrl(e){e?this.setAttribute("feed-url",e):this.removeAttribute("feed-url")}#ex(e){this.#ev.open=!0,this.#ek(e)}#eS(){this.#ev.open=!1}#eC=()=>{e&&e.abort(),this.#eA(),this.feedUrl=null};#eA(){this.#ey.querySelectorAll(".card").forEach(e=>e.remove()),this.#ew.innerHTML="",this.#eg.classList.add("d-none"),this.#eE.classList.add("d-none")}async #ek(t){this.#eg.classList.remove("d-none"),e=new AbortController;try{let o=await t4(t,{signal:e.signal}),{value:i=[]}=await ei(),n=i.find(e=>e.url===t);n&&!n.title&&await er({url:t,title:o.feed.title||""}),this.#ew.textContent=o.feed.title||t,o.items.forEach(e=>{this.#ey.insertAdjacentHTML("beforeend",this.#eT(e))})}catch(e){"AbortError"!==e.name&&(console.error(e),this.#ew.textContent="",this.#eE.classList.remove("d-none"))}finally{this.#eg.classList.add("d-none")}}#eT(e){let{link:t,title:o,description:i,author:n,pubDate:r,thumbnail:a}=e,s="";try{s=new Intl.DateTimeFormat("en-US",{dateStyle:"medium"}).format(new Date(r))}catch{s="-"}return`
    ...
    `}}window.customElements.get("feed-reader")||window.customElements.define("feed-reader",t9),document.adoptedStyleSheets=J}();
//# sourceMappingURL=index.d4146a80.js.map
