...
`;class t0 extends HTMLElement{#j=!1;#H=null;#q=null;#$=null;#V=null;#Y=null;#X=null;#U=null;#W=null;#G=null;#J=null;#Z=null;#K=null;#Q=null;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tQ.content.cloneNode(!0))),this.shadowRoot.adoptedStyleSheets=U,this.#H=this.shadowRoot.getElementById("feedsContainer"),this.#q=this.shadowRoot.getElementById("feedsList"),this.#$=this.shadowRoot.getElementById("editBtn"),this.#V=this.shadowRoot.getElementById("importBtn"),this.#Y=this.shadowRoot.getElementById("importAltBtn"),this.#X=this.shadowRoot.getElementById("exportBtn"),this.#U=this.shadowRoot.getElementById("searchInput"),this.#W=this.shadowRoot.getElementById("searchClearBtn"),this.#G=this.shadowRoot.getElementById("importDialog"),this.#J=this.shadowRoot.getElementById("exportDialog"),this.#Z=this.shadowRoot.querySelector("import-feeds"),this.#K=this.shadowRoot.querySelector("export-feeds"),this.#Q=this.shadowRoot.getElementById("noFeedsDisclaimer")}async connectedCallback(){let{value:e=[]}=await Q();e.forEach(e=>this.#ee(e)),this.#et(),this.#q.addEventListener("click",this.#eo),this.#$.addEventListener("click",this.#ei),this.#Y.addEventListener("click",this.#en),this.#V.addEventListener("click",this.#en),this.#X.addEventListener("click",this.#er),this.#U.addEventListener("input",this.#ea),this.#W.addEventListener("click",this.#es),this.#G.addEventListener("me-open",this.#el),this.#J.addEventListener("me-open",this.#ed),this.#J.addEventListener("me-close",this.#ec),this.addEventListener("feeds-imported",this.#eh),document.addEventListener("feeds-updated",this.#eu),new tO(this.#q,{animation:150,handle:".sort-handler",onEnd:async e=>{let t=Array.prototype.map.call(e.to.querySelectorAll("li"),e=>({url:e.getAttribute("data-url"),title:e.getAttribute("data-title")||""}));await ee(t,!1)}})}disconnectedCallback(){this.#q.removeEventListener("click",this.#eo),this.#$.removeEventListener("click",this.#ei),this.#V.removeEventListener("click",this.#en),this.#Y.removeEventListener("click",this.#en),this.#X.removeEventListener("click",this.#er),this.#U.removeEventListener("input",this.#ea),this.#W.removeEventListener("click",this.#es),this.#G.removeEventListener("me-open",this.#el),this.#J.removeEventListener("me-open",this.#ed),this.#J.removeEventListener("me-close",this.#ec),this.removeEventListener("feeds-imported",this.#eh),document.removeEventListener("feeds-updated",this.#eu)}#ep=(e="")=>{let t=this.#q.querySelectorAll("[data-url]");0!==t.length&&t.forEach(t=>{let o=(t.getAttribute("data-url")||"").toLowerCase(),i=(t.getAttribute("data-title")||"").toLowerCase(),n=e.trim().toLowerCase();t.hidden=!(o.includes(n)||i.includes(n))})};#em=((e,t=0,o=!1)=>{let i=null;if("function"!=typeof e)throw TypeError("Expected a function for first argument");return(...n)=>{clearTimeout(i),o&&!i&&e(...n),i=setTimeout(()=>{i=null,o||e(...n)},t)}})(this.#ep,250);#ea=e=>{let t=e.target.value;return this.#W.classList.toggle("d-none",!t),this.#em(t)};#es=()=>{this.#U.value="",this.#U.dispatchEvent(new Event("input"))};#ei=e=>{this.#j=!this.#j,e.currentTarget.classList.toggle("active"),this.shadowRoot.querySelectorAll(".sort-handler, .delete-button, clipboard-copy").forEach(e=>{e.hidden=!e.hidden})};#en=()=>{this.#G.open=!0};#er=()=>{this.#J.open=!0};#el=()=>{try{this.#Z.shadowRoot.querySelector("a-tab-group").selectTabByIndex(0),this.#Z.shadowRoot.querySelector("textarea").value=""}catch{}};#ed=async()=>{let{value:e=[]}=await Q();this.#K.feeds=e,this.#K.setAttribute("visible","")};#ec=()=>{this.#K.removeAttribute("visible")};#eh=()=>{this.#G.open=!1};#eu=e=>{if("delete"===e.detail.action&&this.#eg(e.detail.feed),"create"===e.detail.action&&(this.#ee(e.detail.feed),this.#U.value&&(this.#U.value="",this.#ep(""))),"update"===e.detail.action){let{url:t,title:o}=e.detail.feed,i=this.#q.querySelector(`[data-url="${t}"]`);if(i){let e=i.querySelector(".link-content");i.setAttribute("data-title",o||""),e&&(e.innerHTML=o?`${o}<br><small class="text-muted">${t}</small>`:t)}}};#eo=e=>{let t=e.target,o=t.closest("button.delete-button"),i=t.closest("a.link");if(!i&&!o)return;let n=t.closest("li").getAttribute("data-url");o&&window.confirm(`Are you sure you want to delete feed "${n}"?`)&&eo(n),i&&(e.preventDefault(),document.querySelector("feed-reader").feedUrl=n)};#ee(e){let{url:t,title:o}=e,i=document.createElement("a");i.className="link text-decoration-none d-flex align-items-center h-100",i.style.flex="1",i.style.minWidth=0,i.style.color="inherit",i.href=t;let n=document.createElement("div");n.className="text-truncate link-content",n.innerHTML=o?`${o}<br><small class="text-muted">${t}</small>`:t;let r=document.createElement("clipboard-copy");r.setAttribute("value",t),r.hidden=this.#j,r.innerHTML=`
    ...
    `;let a=document.createElement("button");a.type="button",a.hidden=!this.#j,a.className="delete-button btn btn-default text-danger p-0",a.style.lineHeight="1",a.setAttribute("aria-label","Delete feed"),a.innerHTML=`
    ...
    `;let s=document.createElement("li");s.className="list-group-item p-0 d-flex justify-content-between align-items-center",s.style.height="var(--list-item-height)",s.setAttribute("data-url",t||""),s.setAttribute("data-title",o||"");let l=document.createElement("div");l.hidden=!this.#j,l.className="sort-handler text-primary",l.setAttribute("aria-label","Reorder feed"),l.innerHTML=`
...
`,t3=document.createElement("template");t3.innerHTML=`
  <style>${t2}</style>
...
`;class t4 extends HTMLElement{#ef=null;#eb=null;#ev=null;#ew=null;#ey=null;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(t3.content.cloneNode(!0))),this.#ef=this.shadowRoot.getElementById("spinner"),this.#eb=this.shadowRoot.querySelector("modal-element"),this.#ev=this.#eb.querySelector("#feedTitle"),this.#ew=this.shadowRoot.getElementById("feedsViewer"),this.#ey=this.shadowRoot.getElementById("error"),this.shadowRoot.adoptedStyleSheets=U}static get observedAttributes(){return["feed-url"]}attributeChangedCallback(e){"feed-url"===e&&(this.feedUrl?this.#eE(this.feedUrl):this.#ex())}connectedCallback(){this.#eb.addEventListener("me-close",this.#eS)}disconnectedCallback(){this.#eb.removeEventListener("me-close",this.#eS)}get feedUrl(){return this.getAttribute("feed-url")}set feedUrl(e){e?this.setAttribute("feed-url",e):this.removeAttribute("feed-url")}#eE(e){this.#eb.open=!0,this.#eC(e)}#ex(){this.#eb.open=!1}#eS=()=>{e&&e.abort(),this.#e_(),this.feedUrl=null};#e_(){this.#ew.querySelectorAll(".card").forEach(e=>e.remove()),this.#ev.innerHTML="",this.#ef.classList.add("d-none"),this.#ey.classList.add("d-none")}async #eC(t){this.#ef.classList.remove("d-none"),e=new AbortController;try{let o=await t5(t,{signal:e.signal}),{value:i=[]}=await Q(),n=i.find(e=>e.url===t);n&&!n.title&&await et({url:t,title:o.feed.title||""}),this.#ev.textContent=o.feed.title||t,o.items.forEach(e=>{this.#ew.insertAdjacentHTML("beforeend",this.#ek(e))})}catch(e){"AbortError"!==e.name&&(console.error(e),this.#ev.textContent="",this.#ey.classList.remove("d-none"))}finally{this.#ef.classList.add("d-none")}}#ek(e){let{link:t,title:o,description:i,author:n,pubDate:r,thumbnail:a}=e,s="";try{s=new Intl.DateTimeFormat("en-US",{dateStyle:"medium"}).format(new Date(r))}catch{s="-"}return`
    ...
    `}}window.customElements.get("feed-reader")||window.customElements.define("feed-reader",t4),document.adoptedStyleSheets=U;
//# sourceMappingURL=rss-feed-reader.b6998b64.js.map
